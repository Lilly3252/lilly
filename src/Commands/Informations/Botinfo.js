...
//**DONE  */
module.exports = {
	data: new SlashCommandBuilder().setName("botinfo").setDescription("information of the bot."),
			...
			embed = new MessageEmbed()
				...
				.addField(
					...
					[
						...
						`**❯ Creation Date:** ${utc(interaction.client.user.createdTimestamp).format(
				...
				.addField("OpenSource Code", `[Click here](https://github.com/Lilly3252/LillyBot)`, !0)
				.addField("OpenSource Code (Dev version)", `[Click here](https://github.com/Lilly3252/Lilly-dev)`, !0)
				.setTimestamp();
