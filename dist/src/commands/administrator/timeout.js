...
export const slashy = new SlashCommandBuilder()
    ...
    .addChoices({ name: "5min", value: "300000" }, { name: "10min", value: "600000" }, { name: "15min", value: "900000" }, { name: "30min", value: "1800000" }, { name: "45min", value: "2700000" }, { name: "1d", value: "86400000" }, { name: "2d", value: "172800000" }, { name: "3d", value: "259200000" }, { name: "4d", value: "345600000" }, { name: "5d", value: "432000000" }, { name: "6d", value: "518400000" }, { name: "1week", value: "604800000" }, { name: "2weeks", value: "1209600000" }, { name: "28days", value: "2419200000" }).setRequired(true))
...
export const run = async (interaction) => {
    ...
    member
        ...
        .then(() => {
        member
            .send(`Hello, you have been timeout in ${interaction.guild.name} for: ${reason}`)
