...
import { APIEmbed, APIEmbedField, ContainerBuilder } from "discord.js";
import i18next from "i18next";

export async function settingEmbed(interaction: InteractionParam, guild_db: guild, language: string | undefined): Promise<ContainerBuilder> {
